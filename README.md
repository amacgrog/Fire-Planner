...
- **Four chart views**: retirement date ±1 year, ±3 years, a 0–7% real CAGR sweep, and a full historical backtest using actual 1928–2025 S&P 500 returns, inflation, and 10-year Treasury bond returns (Damodaran/NYU Stern dataset)
- **Hover-to-inspect charts**: mousing over the ±1yr/±3yr/CAGR views shows a crosshair and each series' value at that age
